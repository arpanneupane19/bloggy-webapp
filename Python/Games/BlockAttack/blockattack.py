...
shape_colors = [(255, 0, 0), (127, 255, 0), (255, 97, 3), (85,26,139), (255, 128, 0), (32, 178, 170), (255, 255, 0)]
...
def draw_next_shape(shape, surface):
    ...
    label = font.render("Coming Up", 1, (0,0,0))
...
def draw_window(surface, grid, score=0, last_score = 0):
    ...
    render_game_name = font.render("Block Attack", 1, (0,0,0))

    surface.blit(render_game_name, (top_left_x + play_width/2 - (render_game_name.get_width()/2), 30))
...
def main_menu(win):
    ...
    while run:
        ...
        draw_text_middle("PRESS ANY KEY TO PLAY", 80, (0,0,0), win)
        pygame.display.update()
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                run = False
...
pygame.display.set_caption("Block Attack  ©ArpanNeupane™")
main_menu(win)